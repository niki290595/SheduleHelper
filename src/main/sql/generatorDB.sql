...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ScheduleDB`.`User` ;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ScheduleDB`.`mainView` (`dayOfWeek` INT, `time` INT, `idAudience` INT, `capacity` INT, `'AudienceType'` INT, `'Discipline'` INT, `'DisciplineType'` INT, `'TeacherFIO'` INT, `academicDegree` INT, `position` INT, `phone` INT, `'Group'` INT, `studentsNumber` INT, `'Direction'` INT, `'DisciplineInAcademicPlan'` INT, `lection` INT, `practice` INT, `lab` INT);
